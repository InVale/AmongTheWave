...
public class BoatPhysics : MonoBehaviour 
{
	...
	void FixedUpdate() 
	{
		...
		//Add Stream Influence
		boatRB.AddForce(Stream.current.MainStream);
	}
	...
	void AddUnderWaterForces()
	{
		...
		float boatMass = boatRB.mass; //Replace VisbyData.mass with your boat's total mass - DONE
	...
	void AddAboveWaterForces()
	{
		...
		for (int i = 0; i < aboveWaterTriangleData.Count; i++)
		{
			...
			//Replace VisbyData.C_r with your boat's drag coefficient - DONE
